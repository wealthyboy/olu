    ...
    <div class="container-fluid">
        ...
        <div class="row no-gutters">
            <div class="portfolio-item-grid col-12 col-lg-6">
                <div class="row justify-content-center">
                    <div class="portfolio-item-grid col-12  col-lg-12">
                        <div style="padding: 60px 90px 70px 90px" class=" mt-2 mb-2">
                            <div class="text-left">
            ...
            <div class="portfolio-item-grid col-12 reduce-gutters col-lg-6 ">
                <div class="portfolio-box position-fixed">
                    <a class="portfolio-thumb" href="#">
                        <img src="/images/banners/ZgFSVgGHOUvQotouviJAqwJIqXDRC4J93p2DuqWQ.jpeg" alt="portfolio Item" />
                    </a>
                </div>
            </div>
        ...
        <div class="row no-gutters">
            <div class="portfolio-item-grid col-12 reduce-gutters col-lg-6">
                <div class="portfolio-box">
                    <a class="portfolio-thumb" href="#">
                        <img src="https://oluremiabimbola.com/images/banners/ZgFSVgGHOUvQotouviJAqwJIqXDRC4J93p2DuqWQ.jpeg" alt="portfolio Item" />
                    </a>
                </div>
            </div>
            <div class="portfolio-item-grid col-12 col-lg-6">
                    ...
                    <div class="portfolio-item-grid col-12  col-lg-12">
                        <div style="padding: 20px 20px 70px 20px" class=" mt-2 mb-2">
                            ...
                            <div class="text-left">
                                ...
                                <p class="fa-12x">
                                    She was a lay reader of the Anglican Church and a holder of both the Ordinary and Advanced Diploma in Bible Studies. She loved Bible Studies and Evangelism. She was one of the first set of students at the Lagos Anglican Bible College (LABICO), Ikeja Campus, which started in 1998 and she later became a Bible College Co-ordinator, a role she cherished for many years. Her happiest day in the week was Sunday, when she was in the church singing, dancing and fellowshipping to her heart’s content. She was a valued member of
                                    the Archbishop Vining Memorial Church Cathedral until her passing on Sunday, 19th July 2020. She was 80 years old.
                                </p>
